...
class Trainer(object):
    ...
    def fit_predict(self, model, train_dataset, valid_dataset, loss_func, activation_fn, dump_dir, fold, target_scaler, feature_name=None):
        ...
        for epoch in range(self.max_epochs):
            ...
            y_preds, val_loss, metric_score, _ = self.predict(
        ...
        y_preds, _, _,_ = self.predict(model, valid_dataset, loss_func, activation_fn,
    ...
    def predict(self, model, dataset, loss_func, activation_fn, dump_dir, fold, target_scaler=None, epoch=1, load_model=False, feature_name=None,dir=None):
        ...
        for i, batch in enumerate(dataloader):
            ...
            with torch.no_grad():
                ...
                feature, outputs = model(**net_input,dir=dir)
                # print('test')
                # exit()
                if features is None:
                    features = feature
        ...
        batch_bar.close()
        return y_preds, val_loss, metric_score, features
